...
/**
 * Pi: commandBuilder client (no native CLI)
 * Uses native HTTP transport with auth field
 */
describe('Client: pi', () => {
    ...
    describe('http transport', () => {
      it('with token auth', () => {
        ...
        expect(command).toMatchInlineSnapshot(
          `"npx -y @gleanwork/configure-mcp-server remote --url https://my-company-be.glean.com/mcp/default --client pi --token my-api-token"`
        );
      });
      ...
      it('with OAuth (URL only, no token)', () => {
        ...
        expect(command).toMatchInlineSnapshot(
          `"npx -y @gleanwork/configure-mcp-server remote --url https://my-company-be.glean.com/mcp/default --client pi"`
        );
      });
    });
  });
